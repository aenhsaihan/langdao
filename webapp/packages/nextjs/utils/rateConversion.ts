 ...
 */
export function hourlyToWeiPerSecond(ratePerHour: number | string, roundToDecimals?: number): number {
 ...
 */
export function formatWeiPerSecondAsHourly(weiPerSecond: number | string | bigint, decimals: number = 2): string {
 ...
 */
export function calculateSessionCost(weiPerSecond: number | bigint, durationSeconds: number): bigint {
