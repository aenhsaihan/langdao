...
export const StudentTutorFinder: React.FC<StudentTutorFinderProps> = ({ onBack, onSessionStart }) => {
  ...
  // Extract rate from tutorInfoData if available
  const tutorRatePerSecond = tutorInfoData ? tutorInfoData[2] : undefined;
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl w-full">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl font-black text-white mb-2">Find Your Perfect Tutor</h2>
              <p className="text-white/70 text-sm">Connect instantly with native speakers and start learning!</p>
            </div>
