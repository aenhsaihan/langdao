    ...
    <div className="fixed top-4 right-4 z-40 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-4 min-w-[280px]">
      ...
      <div className="space-y-1 text-xs text-gray-600 dark:text-gray-300">
        <div className="flex justify-between">
          <span>Duration:</span>
          <span className="font-mono font-medium text-gray-900 dark:text-white">{formatDuration(sessionDuration)}</span>
        </div>
        <div className="flex justify-between">
          <span>Session ID:</span>
          <span className="font-mono">{currentSession.requestId.slice(0, 8)}...</span>
        </div>
        <div className="flex justify-between">
          <span>Tutor:</span>
