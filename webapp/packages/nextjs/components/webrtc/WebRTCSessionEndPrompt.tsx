...
export const WebRTCSessionEndPrompt: React.FC<WebRTCSessionEndPromptProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Session Ended</h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 mb-4">
            <p className="mb-2">
              Your tutoring session has ended. To complete the session and pay your tutor, please confirm the blockchain
              transaction below.
            </p>
