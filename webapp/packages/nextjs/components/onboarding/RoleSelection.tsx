        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          >
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Learn languages with native speakers</p>
              </div>
          ...
          >
            <div className="text-center space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Tutor</h3>
                <p className="text-gray-600 dark:text-gray-300">Teach your native language and earn</p>
              </div>
