  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{localValue.toFixed(4)} PYUSD</div>
        <div className="text-sm text-gray-500 dark:text-gray-400">{percentage.toFixed(1)}% of your balance</div>
      </div>
