...
- **[socket-events.md](tech/socket-events.md)** - Complete Socket.io events reference
- **[api-reference.md](tech/api-reference.md)** - HTTP API documentation
...
### `/ops` - Operations
- **[environment-variables.md](ops/environment-variables.md)** - Complete environment variables reference
...
- **[review-pass-2.md](project/review-pass-2.md)** - Second review pass findings
...
3. Read [tech/socket-events.md](tech/socket-events.md) - Understand real-time matching
...
- **Socket events?** → `tech/socket-events.md`
- **API endpoints?** → `tech/api-reference.md`
- **Environment variables?** → `ops/environment-variables.md`
